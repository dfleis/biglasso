...
RcppExport SEXP _biglasso_loglik_cox(SEXP xPSEXP, SEXP row_idx_SEXP, SEXP betaSEXP, SEXP idx_pSEXP, SEXP idx_lSEXP, SEXP D_R_sets_SEXP, SEXP d_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xP(xPSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type idx_p(idx_pSEXP);
    Rcpp::traits::input_parameter< SEXP >::type idx_l(idx_lSEXP);
    Rcpp::traits::input_parameter< SEXP >::type D_R_sets_(D_R_sets_SEXP);
    Rcpp::traits::input_parameter< SEXP >::type d_(d_SEXP);
    rcpp_result_gen = Rcpp::wrap(loglik_cox(xP, row_idx_, beta, idx_p, idx_l, D_R_sets_, d_));
    return rcpp_result_gen;
END_RCPP
}
